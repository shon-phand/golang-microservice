...
func NewUsersAPI(spec *loads.Document) *UsersAPI {
	return &UsersAPI{
		...
		GetUserByIDGetUserByIDHandler: get_user_by_id.GetUserByIDHandlerFunc(func(params get_user_by_id.GetUserByIDParams) middleware.Responder {
			return middleware.NotImplemented("operation get_user_by_id.GetUserByID has not yet been implemented")
		}),
	}
}

/*UsersAPI Maintaining users database for bookstore_users-api */
type UsersAPI struct {
	...
	// GetUserByIDGetUserByIDHandler sets the operation handler for the get user by Id operation
	GetUserByIDGetUserByIDHandler get_user_by_id.GetUserByIDHandler
...
func (o *UsersAPI) Validate() error {
	...
	if o.GetUserByIDGetUserByIDHandler == nil {
		unregistered = append(unregistered, "GetUserByID.GetUserByIDHandler")
	}
...
func (o *UsersAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/users/{user_id}"] = get_user_by_id.NewGetUserByID(o.context, o.GetUserByIDGetUserByIDHandler)
